        ...
        <nav class="hidden md:flex space-x-8">
          ...
          <div class="relative" @mouseenter="showUsato = true" @mouseleave="showUsato = false">
            ...
            <div v-if="showUsato" class="absolute top-full left-0 pt-1 w-48 z-50">
              <div class="bg-white rounded-lg shadow-lg border border-gray-200">
                <div class="py-1">
                  <NuxtLink to="/moto-usate" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 transition-colors flex items-center gap-2">
          ...
          <div class="relative" @mouseenter="showServizi = true" @mouseleave="showServizi = false">
            ...
            <div v-if="showServizi" class="absolute top-full left-0 pt-1 w-56 z-50">
              <div class="bg-white rounded-lg shadow-lg border border-gray-200">
                <div class="py-1">
                  <NuxtLink to="/servizi" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 transition-colors flex items-center gap-2 font-medium">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path>
                    </svg>
                    Tutti i Servizi
      ...
      <div v-if="mobileMenuOpen" class="md:hidden">
        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 border-t border-gray-200">
          ...
          <div class="px-3 py-2">
            ...
            <div class="ml-4 space-y-1">
              <NuxtLink to="/servizi" class="text-gray-600 hover:text-[#90c149] block px-3 py-1 text-sm flex items-center gap-2 font-medium">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path>
                </svg>
                Tutti i Servizi
