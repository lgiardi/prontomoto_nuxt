...
CREATE TABLE moto_usate_catalogo (
  ...
  categoria VARCHAR(50) NOT NULL, -- 'sportive', 'naked', 'enduro-stradale', 'scooter-ruote-alte', etc.
  cilindrata INTEGER, -- in cc
  immagine_copertina TEXT, -- URL immagine di default
...
CREATE TABLE moto_usate (
  ...
  -- Dati specifici usato
  km INTEGER NOT NULL,
  anno INTEGER NOT NULL,
  prezzo DECIMAL(10,2) NOT NULL,
  condizione VARCHAR(50) NOT NULL, -- 'ottima', 'buona', 'discreta', 'da-ristrutturare'
  descrizione TEXT,
  foto JSONB DEFAULT '[]'::jsonb, -- array di URL foto
  -- Dati venditore
  venditore_id UUID NOT NULL, -- user_id del venditore
...
-- moto_usate_catalogo: tutti possono leggere (è un catalogo pubblico)
CREATE POLICY "moto_usate_catalogo_select_policy" ON moto_usate_catalogo
  FOR SELECT USING (true);

-- Solo admin possono inserire/modificare il catalogo
