# 🗄️ Crea Tabelle Moto Usate in Supabase

## Passo 1: Vai su Supabase Dashboard
1. Apri https://supabase.com/dashboard
2. Seleziona il progetto ProntoMoto
3. Vai su **SQL Editor**

## Passo 2: Esegui questo SQL

```sql
-- 1. Tabella catalogo moto usate (popolata da noi)
...
-- 2. Tabella moto usate (inserite da venditori)
...
## Passo 3: Esegui questo SQL per RLS
...
1. **Verifica le tabelle**: Vai su **Table Editor** e dovresti vedere:
   - `moto_usate_catalogo` (con 50+ moto)
   - `moto_usate` (vuota)

2. **Testa l'API**: Vai su http://localhost:3002/api/moto-usate-catalogo
   - Dovrebbe restituire la lista delle moto del catalogo

3. **Testa le pagine**:
   - http://localhost:3002/moto-usate (pagina pubblica)
   - http://localhost:3002/dealer/moto-usate (per concessionari)
   - http://localhost:3002/dashboard/moto-usate (per privati)

## 🎯 Sistema Completato!

- ✅ **Database**: Tabelle create con RLS
- ✅ **API**: Endpoints funzionanti
- ✅ **Frontend**: Pagine Vue complete
- ✅ **Navigazione**: Link nel menu e dashboard
- ✅ **Sicurezza**: RLS per proteggere i dati

Il sistema moto usate è pronto per essere utilizzato! 🚀
