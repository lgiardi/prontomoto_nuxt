...
-- ============================================
-- Aggiungi campi per supportare servizi (se la tabella esiste già)
...
-- ============================================
-- 7. DATI INIZIALI - SERVIZI CATALOGO
-- ============================================
...
AND table_name IN ('servizi_catalogo', 'servizi_concessionari')
ORDER BY table_name;
